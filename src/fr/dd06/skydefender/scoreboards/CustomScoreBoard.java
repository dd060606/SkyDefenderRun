...
public class CustomScoreBoard {
	 ...
	 */
	public CustomScoreBoard(Player player, String objectiveName) {
		this.player = player;
	...
	/**
	 * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link } in order
	 * to be used again
	 */
	public void destroy() {
		if (!created)
